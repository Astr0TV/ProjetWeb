        ...
        return u;
          ...
          public static void UpdateUser (String nom, String prenom, String mdp, String log) throws SQLException{
           ...
           prepare.execute();
            ...
            public static void InsertConseiller (String nom, String prenom,String login, String mdp) throws SQLException{
           String sql ="INSERT INTO banqueesic.person (nom, prenom, login, mdp,etat,type) VALUES (?,?,?,?,1,'conseiller');";
           Connection connexion = AccessBd.getConnection();
           PreparedStatement prepare = connexion.prepareStatement(sql);
           prepare.setString(1, nom);
           prepare.setString(2, prenom);
