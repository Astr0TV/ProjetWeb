 ...
 * @author Huawei
 */
@WebServlet(name = "DesactiverCompteServlet", urlPatterns = {"/DesactiverCompte"})
public class DesactiverCompteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DesactiverCompteServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DesactiverCompteServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            throws ServletException, IOException {
                ...
                if (user != null) {
                    try {
                        ...
                        CompteDao.DesactiverCompte(nucarte);
